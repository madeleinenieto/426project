...
var script = {
  name: 'BSteps',
  components: (_components = {}, __chunk_1._defineProperty(_components, __chunk_5.Icon.name, __chunk_5.Icon), __chunk_1._defineProperty(_components, __chunk_24.SlotComponent.name, __chunk_24.SlotComponent), _components),
  props: {
    value: Number,
    type: [String, Object],
    size: String,
