...
require('./chunk-102d949d.js');
var __chunk_6 = require('./chunk-13e039f5.js');
require('./chunk-8b50156f.js');
require('./chunk-500d62cc.js');
var autocomplete = require('./autocomplete.js');
var button = require('./button.js');
var carousel = require('./carousel.js');
require('./chunk-8b8384ca.js');
require('./chunk-375b4e3a.js');
var checkbox = require('./checkbox.js');
var collapse = require('./collapse.js');
require('./chunk-5dd3cd94.js');
require('./chunk-c5b5b708.js');
require('./chunk-9cf8a0e6.js');
require('./chunk-6693d54d.js');
var clockpicker = require('./clockpicker.js');
require('./chunk-bfd50768.js');
require('./chunk-2ae6f8d1.js');
var datepicker = require('./datepicker.js');
require('./chunk-2143e0d3.js');
var datetimepicker = require('./datetimepicker.js');
require('vue');
require('./chunk-10dcd885.js');
...
require('./chunk-612bac13.js');
var message = require('./message.js');
var modal = require('./modal.js');
var notification = require('./notification.js');
require('./chunk-c6c35e89.js');
var navbar = require('./navbar.js');
var numberinput = require('./numberinput.js');
require('./chunk-2fc413c4.js');
var pagination = require('./pagination.js');
var progress = require('./progress.js');
var radio = require('./radio.js');
var rate = require('./rate.js');
var select = require('./select.js');
require('./chunk-95aea8f1.js');
...
var Buefy = {
  install: function install(Vue) {
    ...
    // Options
    __chunk_3.setOptions(__chunk_2.merge(__chunk_3.config, options, true)); // Components
    ...
    var BuefyProgrammatic = {
      getOptions: function getOptions() {
        return __chunk_3.config;
      },
      setOptions: function setOptions(options) {
        __chunk_3.setOptions(__chunk_2.merge(__chunk_3.config, options, true));
      }
    };
